...
define([
	...
	function getRotationOptions(
		...
		nwCartesian = Cartesian2.Cartesian3.subtract(
			nwCartesian,
			centerCartesian,
			nwCartesian,
		)
		var rotationMatrix = GeometryAttribute.Matrix2.fromRotation(
			rotation,
		...
		nwCartesian = Cartesian2.Cartesian3.add(
			nwCartesian,
			centerCartesian,
			nwCartesian,
		)
	...
	RectangleGeometryLibrary.computeOptions = function (
		...
		var boundingRectangle = Cartesian2.Rectangle.clone(
			rectangle,
			boundingRectangleScratch,
		)
		...
		if (stRotation !== 0) {
			...
			var stNwCorner = Cartesian2.Rectangle.northwest(
				boundingRectangle,
				stNwCornerResult,
			)
