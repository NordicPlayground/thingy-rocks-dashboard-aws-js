...
define([
	...
	'./BoxGeometry-7becdd54',
	'./CylinderGeometryLibrary-fb6b122a',
	'./CylinderGeometry-0e3d086d',
	'./EllipsoidGeometry-57437970',
	'./Color-7c010fd0',
], function (
	when,
	Check,
	...
	var packedBoxLength =
		Transforms.Matrix4.packedLength + Cartesian2.Cartesian3.packedLength
	var packedCylinderLength = Transforms.Matrix4.packedLength + 2
	var packedEllipsoidLength =
		Transforms.Matrix4.packedLength + Cartesian2.Cartesian3.packedLength
	...
	function boxModelMatrixAndBoundingVolume(boxes, index) {
		...
		var dimensions = Cartesian2.Cartesian3.unpack(
			boxes,
			boxIndex,
			scratchCartesian,
		)
		...
		Transforms.Matrix4.multiplyByScale(
			boxModelMatrix,
			dimensions,
			boxModelMatrix,
		)
	...
	function ellipsoidModelMatrixAndBoundingVolume(ellipsoids, index) {
		...
		var radii = Cartesian2.Cartesian3.unpack(
			ellipsoids,
			ellipsoidIndex,
			scratchCartesian,
		)
	...
	function createVectorTileGeometries(parameters, transferableObjects) {
		...
		var numberOfCylinders = when.defined(cylinders)
			? cylinderBatchIds.length
			: 0
		var numberOfEllipsoids = when.defined(ellipsoids)
