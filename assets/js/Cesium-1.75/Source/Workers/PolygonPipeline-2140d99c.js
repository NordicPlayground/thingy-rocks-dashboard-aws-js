...
define([
	...
	PolygonPipeline.computeRhumbLineSubdivision = function (
		...
		var rhumb0 = new EllipsoidRhumbLine.EllipsoidRhumbLine(
			undefined,
			undefined,
			ellipsoid,
		)
		var rhumb1 = new EllipsoidRhumbLine.EllipsoidRhumbLine(
			undefined,
			undefined,
			ellipsoid,
		)
		var rhumb2 = new EllipsoidRhumbLine.EllipsoidRhumbLine(
			undefined,
			undefined,
			ellipsoid,
		)
