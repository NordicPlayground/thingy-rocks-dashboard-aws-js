...
define([
	...
	function computeTopBottomAttributes(positions, options, extrude) {
		...
		if (stRotation !== 0) {
			...
			tangentMatrix = Transforms.Matrix3.clone(
				Transforms.Matrix3.IDENTITY,
				tangentMatrix,
			)
		}
	...
	function computeWallAttributes(positions, options) {
		...
		for (var i = 0; i < length; i += 3) {
			...
			extrudedPosition = Cartesian2.Cartesian3.clone(
				position,
				scratchCartesian2,
			)
			normal = ellipsoid.geodeticSurfaceNormal(position, normal)
	...
	function computeRectangle(
		...
		var rectangle = Cartesian2.Rectangle.fromCartesianArray(
			positions,
			ellipsoid,
			result,
		)
	...
	EllipseGeometry.unpack = function (array, startingIndex, result) {
		...
		var center = Cartesian2.Cartesian3.unpack(
			array,
			startingIndex,
			scratchCenter,
		)
