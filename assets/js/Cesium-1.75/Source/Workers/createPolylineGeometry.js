...
define([
	...
	function PolylineGeometry(options) {
		...
		numComponents += when.defined(colors)
	...
	PolylineGeometry.createGeometry = function (polylineGeometry) {
		...
		if (
			...
			var heights = PolylinePipeline.PolylinePipeline.extractHeights(
				positions,
				ellipsoid,
			)
		...
		var finalColors = when.defined(colors)
	...
	function createPolylineGeometry(polylineGeometry, offset) {
		...
		polylineGeometry._ellipsoid = Cartesian2.Ellipsoid.clone(
			polylineGeometry._ellipsoid,
		)
