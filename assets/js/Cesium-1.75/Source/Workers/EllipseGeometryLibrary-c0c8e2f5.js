...
define([
	...
	'./Cartesian2-a27b2f0f',
	'./Transforms-522dafc7',
], function (exports, _Math, Cartesian2, Transforms) {
	'use strict'
	...
	EllipseGeometryLibrary.raisePositionsToHeight = function (
		...
		for (var i = 0; i < length; i += 3) {
			...
			var extrudedPosition = Cartesian2.Cartesian3.clone(
				position,
				scratchCartesian2,
			)
