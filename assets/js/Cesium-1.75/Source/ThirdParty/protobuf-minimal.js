	...
	;(function prelude(modules, cache, entries) {
		...
		/* end of prelude */ {
			...
			7: [
				...
				{ 10: 10, 13: 13, 14: 14, 15: 15, 8: 8, 9: 9 },
			],
			8: [
				function (require, module, exports) {
					'use strict'
					...
					function readFixed64(/* this: Reader */) {
						...
						return new LongBits(
							readFixed32(this.buf, (this.pos += 4)),
							readFixed32(this.buf, (this.pos += 4)),
						)
					}
				...
				function (require, module, exports) {
					...
					util.lazyResolve = function lazyResolve(root, lazyTypes) {
						for (var i = 0; i < lazyTypes.length; ++i) {
							for (
								var keys = Object.keys(lazyTypes[i]), j = 0;
								j < keys.length;
								++j
							) {
			...
			14: [
				function (require, module, exports) {
					...
					Writer.prototype.fixed64 = function write_fixed64(value) {
						var bits = LongBits.from(value)
						return this.push(writeFixed32, 4, bits.lo).push(
							writeFixed32,
							4,
							bits.hi,
						)
							...
							: /* istanbul ignore next */
							  function writeFloat_ieee754(value, buf, pos) {
									...
									if (value === 0)
										...
										writeFixed32(
											((sign << 31) |
												Math.round(value / 1.401298464324817e-45)) >>>
												0,
											buf,
											pos,
										)
										...
										var exponent = Math.floor(Math.log(value) / Math.LN2),
											mantissa =
												Math.round(value * Math.pow(2, -exponent) * 8388608) &
												8388607
										writeFixed32(
