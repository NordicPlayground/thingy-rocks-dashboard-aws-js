...
function executeDebugGlobeDepth(globeDepth, context, passState, useLogDepth) {
	if (
		...
		globeDepth._debugGlobeDepthViewportCommand =
			context.createViewportQuadCommand(fs, {
				uniformMap: {
...
GlobeDepth.prototype.destroy = function () {
	...
	if (defined(this._mergeColorCommand)) {
		this._mergeColorCommand.shaderProgram =
			this._mergeColorCommand.shaderProgram.destroy()
	}
