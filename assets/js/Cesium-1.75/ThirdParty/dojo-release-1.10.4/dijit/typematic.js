define([
	...
	var typematic = (dijit.typematic = {
		...
		addKeyListener: function (
			...
			var type =
					'keyCode' in keyObject
						? 'keydown'
						: 'charCode' in keyObject
						? 'keypress'
						: connect._keypress,
				attr =
					'keyCode' in keyObject
			...
			var handles = [
				on(
					...
					lang.hitch(this, function (evt) {
						if (
							evt[attr] == keyObject[attr] &&
							(keyObject.ctrlKey === undefined ||
								keyObject.ctrlKey == evt.ctrlKey) &&
							(keyObject.altKey === undefined ||
								keyObject.altKey == evt.altKey) &&
							(keyObject.metaKey === undefined ||
								keyObject.metaKey == (evt.metaKey || false)) && // IE doesn't even set metaKey
							(keyObject.shiftKey === undefined ||
								keyObject.shiftKey == evt.shiftKey)
						) {
							evt.stopPropagation()
							evt.preventDefault()
							typematic.trigger(
