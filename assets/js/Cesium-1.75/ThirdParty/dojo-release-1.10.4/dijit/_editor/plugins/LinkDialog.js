			...
			require([
				...
				this.own(
					registry
						...
						.on('click', lang.hitch(this.dropDown, 'onCancel')),
				)
				if (this._urlInput) {
					this.own(
						this._urlInput.on('change', lang.hitch(this, '_checkAndFixInput')),
					)
				}
				if (this._textInput) {
					this.own(
						this._textInput.on('change', lang.hitch(this, '_checkAndFixInput')),
					)
				}
