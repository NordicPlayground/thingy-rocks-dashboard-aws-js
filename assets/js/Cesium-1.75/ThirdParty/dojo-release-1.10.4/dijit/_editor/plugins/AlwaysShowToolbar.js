define([
	...
	return declare('dijit._editor.plugins.AlwaysShowToolbar', _Plugin, {
		...
		globalOnScrollHandler: function () {
			...
			if (
				scrollPos > this._scrollThreshold &&
				scrollPos < this._scrollThreshold + this._lastHeight
			) {
				...
				if (isIE6) {
					...
					if (this._IEOriginalPos) {
						domConstruct.place(
							tdn,
							this._IEOriginalPos[1],
							this._IEOriginalPos[0],
						)
