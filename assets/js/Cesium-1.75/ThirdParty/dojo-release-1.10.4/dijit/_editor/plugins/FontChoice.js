define([
	...
	var _FontDropDown = declare(
		...
		[_Widget, _TemplatedMixin, _WidgetsInTemplateMixin],
		{
			...
			_setValueAttr: function (value, priorityChange) {
				...
				this.select.set(
					'value',
					array.indexOf(this.values, value) < 0 ? '' : value,
					priorityChange,
				)
				if (!priorityChange) {
		...
		_FontDropDown,
		{
			...
			_setValueAttr: function (value, priorityChange) {
				...
				if (value.indexOf && value.indexOf('px') != -1) {
					...
					value =
						{ 10: 1, 13: 2, 16: 3, 18: 4, 24: 5, 32: 6, 48: 7 }[pixels] || value
				}
	...
	var _FormatBlockDropDown = declare(
	...
	var FontChoice = declare('dijit._editor.plugins.FontChoice', _Plugin, {
		...
		_initButton: function () {
			...
			this.button = new clazz(
				lang.delegate({ dir: editor.dir, lang: editor.lang }, params),
			)
			...
			this.own(
				this.button.select.on(
					'change',
					lang.hitch(this, function (choice) {
