		 ...
		 =====*/
			...
			_showText: function () {
				...
				var sinceMidnight = function (/*Date*/ date) {
					...
					clickableIncrementSeconds = sinceMidnight(
				...
				this._visibleIncrement =
					visibleIncrementSeconds / clickableIncrementSeconds
				...
				this._maxIncrement = Math.ceil(
					(visibleRange + 1) / clickableIncrementSeconds,
				)
			...
			_createOption: function (/*Number*/ index) {
				...
				date.setHours(
					date.getHours() + incrementDate.getHours() * index,
				...
				if (
					this.filterString &&
					dateString.toLowerCase().indexOf(this.filterString) !== 0
				) {
				...
				if (
					index % this._visibleIncrement < 1 &&
					index % this._visibleIncrement > -1
				) {
				...
				if (
					this.value &&
					!ddate.compare(this.value, date, this.constraints.selector)
				) {
					div.selected = true
