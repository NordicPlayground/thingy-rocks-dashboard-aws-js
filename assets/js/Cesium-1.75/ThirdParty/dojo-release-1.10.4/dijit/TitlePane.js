define([
	...
	var TitlePane = declare(
		'dijit.TitlePane',
		[ContentPane, _TemplatedMixin, _CssStateMixin],
		{
			// summary:
			...
			_setCss: function () {
				...
				domClass.replace(
					node,
					this._titleBarClass.replace('TitlePaneTitle', ''),
					(oldCls || '').replace('TitlePaneTitle', ''),
				)
