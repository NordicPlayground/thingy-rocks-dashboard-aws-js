	...
	return declare('dijit.tree.ObjectStoreModel', Destroyable, {
					...
					lang.hitch(this, function (items) {
						...
						if (res.observe) {
							res.observe(
								...
								true,
							) // true to listen for updates to obj
						}
					}),
					onError,
				)
		...
		getChildren: function (
			...
			if (res.observe) {
				this.own(
					res.observe(
						lang.hitch(this, function (obj, removedFrom, insertedInto) {
				...
				) // true means to notify on item changes
			}
		...
		newItem: function (
			/* dijit/tree/dndSource.__Item */ args,
			/*Item*/ parent,
			/*int?*/ insertIndex,
			/*Item*/ before,
		) {
		...
		pasteItem: function (
			...
			if (oldParentItem && !bCopy) {
				...
				this.getChildren(
					oldParentItem,
					lang.hitch(this, function (oldParentChildren) {
		...
		onChange: function () /*dojo/data/Item*/
		/*===== item =====*/ {
			// summary:
		...
		onDelete: function () /*dojo/data/Item*/
		/*===== item =====*/ {
			// summary:
