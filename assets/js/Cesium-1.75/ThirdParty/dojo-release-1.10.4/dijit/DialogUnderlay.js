define([
	...
	var DialogUnderlay = declare(
		...
		[_Widget, _TemplatedMixin],
		{
			...
			templateString:
				"<div class='dijitDialogUnderlayWrapper'><div class='dijitDialogUnderlay' tabIndex='-1' data-dojo-attach-point='node'></div></div>",
	...
	DialogUnderlay.show = function (/*Object*/ attrs, /*Number*/ zIndex) {
		...
		if (!underlay || underlay._destroyed) {
			underlay =
				dijit._underlay =
				DialogUnderlay._singleton =
					new DialogUnderlay(attrs)
		} else {
			if (attrs) {
				underlay.set(attrs)
			}
