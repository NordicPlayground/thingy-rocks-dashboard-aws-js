define([
	...
	return declare(
		'dijit.layout._TabContainerBase',
		[StackContainer, _TemplatedMixin],
		{
			// summary:
			...
			layout: function () {
				...
				if (this.doLayout) {
					...
					this._containerContentBox = layoutUtils.marginBox2contentBox(
						this.containerNode,
						children[2],
					)
