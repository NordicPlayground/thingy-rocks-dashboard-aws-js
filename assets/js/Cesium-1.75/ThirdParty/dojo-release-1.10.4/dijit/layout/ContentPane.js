define([
	...
	return declare(
		'dijit.layout.ContentPane',
		[_Widget, _Container, _ContentPaneResizeMixin],
		{
			// summary:
		 ...
		 ======*/
			...
			markupFactory: function (params, node, ctor) {
				...
				return !self.href &&
					self._contentSetter &&
					self._contentSetter.parseDeferred &&
					!self._contentSetter.parseDeferred.isFulfilled()
			...
			_onShow: function () {
				...
				if (this.href) {
					if (
						!this._xhrDfd && // if there's an href that isn't already being loaded
			...
			_setContent: function (
				...
				var p = setter.set(
					lang.isObject(cont) && cont.domNode ? cont.domNode : cont,
					setterParams,
				)
