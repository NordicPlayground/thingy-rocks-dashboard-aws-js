define([
	...
	var TabButton = declare(
		'dijit.layout._TabButton' + (has('dojo-bidi') ? '_NoBidi' : ''),
		StackController.StackButton,
		{
			// summary:
	...
	var TabController = declare('dijit.layout.TabController', StackController, {
		...
		templateString:
			"<div role='tablist' data-dojo-attach-event='onkeydown:onkeydown'></div>",
		...
		postCreate: function () {
			...
			var closeMenu = new Menu({
				...
				selector: function (node) {
					return (
						domClass.contains(node, 'dijitClosable') &&
						!domClass.contains(node, 'dijitTabDisabled')
					)
				},
			})
			this.own(closeMenu)
