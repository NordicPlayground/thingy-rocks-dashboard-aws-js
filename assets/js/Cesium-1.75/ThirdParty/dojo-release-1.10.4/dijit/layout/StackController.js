		...
		[_Widget, _TemplatedMixin, _Container],
		{
			...
			onAddChild: function (
				...
				var labelledby = page._wrapper.getAttribute('aria-labelledby')
					? page._wrapper.getAttribute('aria-labelledby') + ' ' + button.id
					: button.id
