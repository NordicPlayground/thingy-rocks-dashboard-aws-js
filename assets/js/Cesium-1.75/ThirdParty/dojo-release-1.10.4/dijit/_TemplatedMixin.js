...
=====*/
		...
		buildRendering: function () {
			...
			if (!this._rendered) {
				...
				var cached = _TemplatedMixin.getCachedTemplate(
					this.templateString,
					this._skipNodeCache,
					this.ownerDocument,
				)
	...
	_TemplatedMixin.getCachedTemplate = function (
		templateString,
		alwaysUseString,
		doc,
	) {
		...
		if (cached) {
			try {
				...
				if (
					!cached.ownerDocument ||
					cached.ownerDocument == (doc || document)
				) {
