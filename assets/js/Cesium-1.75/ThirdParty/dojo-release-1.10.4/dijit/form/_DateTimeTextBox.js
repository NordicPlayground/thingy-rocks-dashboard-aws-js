define([
	...
	var _DateTimeTextBox = declare(
		'dijit.form._DateTimeTextBox',
		[RangeBoundTextBox, _HasDropDown],
		{
			// summary:
		...
		======*/
			...
			format: function (
				/*Date*/ value,
				/*locale.__FormatOptions*/ constraints,
			) {
				// summary:
			...
			parse: function (
				...
				return (
					this.dateLocaleModule.parse(value, constraints) ||
			...
			_setConstraintsAttr: function (/*Object*/ constraints) {
				...
				this.inherited(arguments)
				this._unboundedConstraints = lang.mixin({}, this.constraints, {
					min: null,
					max: null,
				})
			},
			...
			_set: function (attr, value) {
				...
				if (attr == 'value') {
					...
					if (
						oldValue instanceof this.dateClassObj &&
						this.compare(value, oldValue) == 0
					) {
						return
					}
				}
