define([
	...
	return (ValidationTextBox = declare('dijit.form.ValidationTextBox', TextBox, {
		...
		regExpGen: function () /*__Constraints*/
		/*===== constraints =====*/ {
			// summary:
		...
		validator: function (/*anything*/ value, /*__Constraints*/ constraints) {
			...
			return (
				new RegExp(
					'^(?:' +
						this._computeRegexp(constraints) +
						')' +
						(this.required ? '' : '?') +
						'$',
				).test(value) &&
		...
		getErrorMessage: function () /*Boolean*/
		/*===== isFocused =====*/ {
			// summary:
		...
		getPromptMessage: function () /*Boolean*/
		/*===== isFocused =====*/ {
			// summary:
		...
		validate: function (/*Boolean*/ isFocused) {
			...
			this._set(
				...
				isValid
					? ''
					: (((!this._hasBeenBlurred || isFocused) && isEmpty) ||
							isValidSubset) &&
					  (this._maskValidSubsetError ||
							(isValidSubset && !this._hasBeenBlurred && isFocused))
					? 'Incomplete'
					: 'Error',
			)
		...
		_computeRegexp: function (/*__Constraints*/ constraints) {
			...
			if (p != this._lastRegExp) {
				...
				try {
					...
					console.warn(
						'RegExp error in ' + this.declaredClass + ': ' + this.pattern,
					)
				} // should never be here unless the original RE is bad or the parsing is bad
