define([
		...
		[_WidgetBase, _TemplatedMixin],
		{
			...
			_setValueAttr: function (
				...
				if (
					...
					if (
						this._created &&
						(priorityChange || typeof priorityChange == 'undefined')
					) {
			...
			_populateGrid: function () {
				...
				var firstDay = month.getDay(),
					...
					daysInPreviousMonth = this.dateModule.getDaysInMonth(
				...
				if (!this.summary) {
					var monthNames = this.dateLocaleModule.getNames(
						'months',
						'wide',
						'standAlone',
						this.lang,
			...
			constructor: function (params /*===== , srcNodeRef =====*/) {
				...
				this.dateModule = params.datePackage
					? lang.getObject(params.datePackage, false)
					: date
				this.dateClassObj = this.dateModule.Date || Date
				this.dateLocaleModule = params.datePackage
					? lang.getObject(params.datePackage + '.locale', false)
					: locale
			},
			...
			buildRendering: function () {
				...
				var d = this.dowTemplateString,
					dayNames = this.dateLocaleModule.getNames(
						'days',
						this.dayWidth,
						'standAlone',
						this.lang,
					...
					dayOffset = cldrSupplemental.getFirstDayOfWeek(this.lang)
				this.dayCellsHtml = string.substitute(
					[d, d, d, d, d, d, d].join(''),
					{ d: '' },
					function () {
					...
					return on(
						...
						lang.hitch(this, function () {
							this._setCurrentFocusAttr(
								this.dateModule.add(this.currentFocus, part, amount),
							)
						}),
					)
				})
			...
			_setCurrentFocusAttr: function (/*Date*/ date, /*Boolean*/ forceFocus) {
				...
				if (
					!this._date2cell ||
					this.dateModule.difference(oldFocus, date, 'month') != 0
				) {
					this._populateGrid()
	...
	CalendarLite._MonthWidget = declare(
