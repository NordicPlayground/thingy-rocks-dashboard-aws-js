define([
	...
	function doClicks(e, moveType, endType) {
		...
		if (clickTracker) {
			...
			clickX = e.changedTouches
				? e.changedTouches[0].pageX - win.global.pageXOffset
				: e.clientX
			clickY = e.changedTouches
				? e.changedTouches[0].pageY - win.global.pageYOffset
				: e.clientY
			clickDx =
			...
			if (!clicksInited) {
				...
				function updateClickTracker(e) {
					if (useTarget) {
						...
						clickTracker =
							clickTracker &&
							(e.changedTouches ? e.changedTouches[0].target : e.target) ==
								clickTarget &&
							Math.abs(
								(e.changedTouches
									? e.changedTouches[0].pageX - win.global.pageXOffset
	...
	var touch = {
		...
		cancel: dualEvent(
			mouse.leave,
			'touchcancel',
			hasPointer ? pointer.cancel : null,
		),
		over: dualEvent('mouseover', 'dojotouchover', pointer.over),
		out: dualEvent('mouseout', 'dojotouchout', pointer.out),
		enter: mouse._eventHandler(
			dualEvent('mouseover', 'dojotouchover', pointer.over),
		),
		leave: mouse._eventHandler(
			dualEvent('mouseout', 'dojotouchout', pointer.out),
		),
	}
