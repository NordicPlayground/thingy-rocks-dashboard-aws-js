define(//begin v1.x content
{
	...
	'days-standAlone-short': ['א׳', 'ב׳', 'ג׳', 'ד׳', 'ה׳', 'ו׳', 'ש׳'],
	...
	'quarters-standAlone-narrow': ['ר1', 'ר2', 'ר3', 'ר4'],
	...
	eraNarrow: ['לפנה״ס', 'BCE', 'לסה״נ', 'CE'],
	'dateFormatItem-yMM': 'MM/y',
	'field-tue-relative+-1': 'יום שלישי שעבר',
	'days-format-short': ['א׳', 'ב׳', 'ג׳', 'ד׳', 'ה׳', 'ו׳', 'ש׳'],
	...
	'quarters-format-abbr': ['רבעון 1', 'רבעון 2', 'רבעון 3', 'רבעון 4'],
	'quarters-standAlone-wide': ['רבעון 1', 'רבעון 2', 'רבעון 3', 'רבעון 4'],
	...
	'quarters-standAlone-abbr': ['רבעון 1', 'רבעון 2', 'רבעון 3', 'רבעון 4'],
	eraAbbr: ['לפנה״ס', 'BCE', 'לסה״נ', 'CE'],
	'field-minute': 'דקה',
	...
	eraNames: ['לפני הספירה', 'לספירה', 'לסה״נ', 'CE'],
	'days-format-narrow': ['א׳', 'ב׳', 'ג׳', 'ד׳', 'ה׳', 'ו׳', 'ש׳'],
