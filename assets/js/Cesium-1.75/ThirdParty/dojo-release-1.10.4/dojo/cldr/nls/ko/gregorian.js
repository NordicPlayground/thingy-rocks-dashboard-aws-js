define(//begin v1.x content
{
	...
	'days-standAlone-short': ['일', '월', '화', '수', '목', '금', '토'],
	...
	'days-format-short': ['일', '월', '화', '수', '목', '금', '토'],
	...
	'quarters-standAlone-abbr': ['1분기', '2분기', '3분기', '4분기'],
	eraAbbr: ['기원전', '서기'],
	'field-minute': '분',
	'field-dayperiod': '오전/오후',
	'days-standAlone-abbr': ['일', '월', '화', '수', '목', '금', '토'],
	'dateFormatItem-d': 'd일',
	...
	eraNames: ['서력기원전', '서력기원'],
	'days-format-narrow': ['일', '월', '화', '수', '목', '금', '토'],
