define(//begin v1.x content
{
	...
	'days-standAlone-short': ['dom', 'lun', 'mar', 'mer', 'gio', 'ven', 'sab'],
	...
	eraNarrow: ['aC', 'BCE', 'dC', 'CE'],
	'field-tue-relative+-1': 'martedì scorso',
	'days-format-short': ['dom', 'lun', 'mar', 'mer', 'gio', 'ven', 'sab'],
	...
	eraAbbr: ['aC', 'BCE', 'dC', 'CE'],
	'field-minute': 'minuto',
	'field-dayperiod': 'periodo del giorno',
	'days-standAlone-abbr': ['dom', 'lun', 'mar', 'mer', 'gio', 'ven', 'sab'],
	'dateFormatItem-d': 'd',
	...
	eraNames: ['a.C.', 'BCE', 'd.C.', 'CE'],
	'days-format-narrow': ['D', 'L', 'M', 'M', 'G', 'V', 'S'],
