...
{
	'days-standAlone-short': ['V', 'H', 'K', 'Sze', 'Cs', 'P', 'Szo'],
	...
	'days-format-short': ['V', 'H', 'K', 'Sze', 'Cs', 'P', 'Szo'],
	...
	'quarters-format-abbr': ['N1', 'N2', 'N3', 'N4'],
	...
	'quarters-standAlone-abbr': ['N1', 'N2', 'N3', 'N4'],
	eraAbbr: ['BK'],
	'field-minute': 'perc',
	'field-dayperiod': 'napszak',
	'days-standAlone-abbr': ['V', 'H', 'K', 'Sze', 'Cs', 'P', 'Szo'],
	...
	'days-format-abbr': ['V', 'H', 'K', 'Sze', 'Cs', 'P', 'Szo'],
	eraNames: ['BK'],
	'days-format-narrow': ['V', 'H', 'K', 'Sz', 'Cs', 'P', 'Sz'],
