						...
						for (
							...
							var _,
								v = (function (e, t, r, o, a, i, n, s, l) {
									...
									if (i || n) {
										var c =
												F.PolygonGeometryLibrary.createGeometryFromPositions(
													e,
													t,
													r,
													a,
							...
							s && l
								? ((_ = v.topAndBottom),
								  (b.geometry =
										F.PolygonGeometryLibrary.scaleToGeodeticHeightExtruded(
											_.geometry,
											h,
											f,
											r,
								...
								: s
								? (((_ = v.topAndBottom).geometry.attributes.position.values =
										V.PolygonPipeline.scaleToGeodeticHeight(
